...
vim.keymap.set('n', '<leader>fs', '<cmd>w<CR>', { desc = 'Save the opened file with :w' })
          ...
          settings = {
            basedpyright = {
              ...
              on_init = function(client)
                client.config.settings.basedpyright = vim.tbl_deep_extend('force',
                  client.config.settings.basedpyright or {}, {
